...
const Reviews = async () => {
  ...
  return (
    <div className="max-w-screen-2xl w-full mb-20">
      <div className='flex justify-center'>
        <div className='md:max-w-2xl p-4 mt-8'>
          ...
          <div>
            {reviews.map(review => (
              <div key={review.time} className='text-sm border px-4 py-3 max-w-md'>
                <div className="flex items-center w-fill justify-between mb-4">
